...
* **ถอดรหัสเลขฐาน 16:** `0x48e` แปลงเป็นเลขฐานสิบคือ $(4 \times 256) + (8 \times 16) + 14 = \mathbf{1166}$ ซึ่งตรงกับสแตท `EMagicStatType_WorldSpeedPropotionToCharacterHealth` (รถพยาบาล) ของแท้แน่นอน
...
* **คำอธิบาย:** หากมีค่าบัฟความเร็ว:
  ...
  4. **ถอดรหัสค่าคงที่:** ค่า `0x3f50624d:d2f1a9fc` คือทศนิยม **`0.001`**
     * ตัวอย่าง: เมื่อนำค่าดิบจากตารางสมบัติ `1150` มาคูณ จะได้ $1150 \times 0.001 = \mathbf{1.150}$ ($+15.0\%$)
